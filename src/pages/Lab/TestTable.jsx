...
const statusColors = {
  ...
  Collected: "bg-green-300 text-green-700",
  "Not Collected": "bg-yellow-200 text-yellow-700",
};
...
export default function TestTable() {
  ...
  function handleCreateReport() {
    navigate("/labNormalReport");
  }

  useEffect(() => {
    fetch("/public/lab.json")
      .then((res) => {
    ...
    <div className="bg-white p-6 border rounded-xl shadow-xl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={handleCreateReport} className="bg-blue-300 text-white px-4 py-2 gap-2 rounded-xl cursor-pointer">
            Create Report
          </button>
        </div>
      </div>
      ...
      <table className="w-full border-collapse rounded-xl overflow-hidden shadow">
        <thead>
          <tr className="bg-blue-100 text-left text-sm font-semibold text-gray-700">
            ...
            <th className="px-4 py-3">Collect Sample</th>
