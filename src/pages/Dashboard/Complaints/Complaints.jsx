...
const statusColors = {
  ...
  Progress: "bg-lime-600 text-white",
};
      ...
      <div className="w-full flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <option
              value="Solved"
              className="bg-green-300 text-green-700 rounded-xl"
            >
              Solved
            </option>
            <option
              value="Pending"
              className="bg-yellow-200 text-yellow-700 rounded-xl"
            >
              Pending
            </option>
            <option
      ...
      <table className="w-full border-collapse rounded-xl overflow-hidden shadow">
        <thead>
          <tr className="bg-blue-100 text-left text-sm font-semibold text-gray-700">
            ...
            <th className="px-4 py-3">Complain time</th>
          </tr>
        </thead>
        <tbody>
