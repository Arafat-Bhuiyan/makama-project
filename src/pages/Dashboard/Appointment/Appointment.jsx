...
const statusColors = {
  New: "bg-green-300 text-green-700",
  Old: "bg-yellow-200 text-yellow-700",
};
...
export default function AppointmentTable() {
  ...
  const filteredData = appointmentsData.filter((item) => {
    ...
    const matchesStats = statsFilter === "Status" || item.status === statsFilter;
